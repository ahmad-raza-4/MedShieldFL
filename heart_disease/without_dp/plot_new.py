...
results = pd.read_csv("seed_42.csv")
...
# Change x-axis scale to linear
ax.set_xscale("linear")

# Updated tick values and labels for equal spacing
xtick_values = [1, 10, 20, 30]
xlabels = [str(v) for v in xtick_values]
ax.set_xticks(xtick_values)
ax.set_xticklabels(xlabels)

# Adjusted horizontal line for baseline
ax.axhline(
...
plt.savefig("seed_42.pdf", dpi=100, bbox_inches="tight")
