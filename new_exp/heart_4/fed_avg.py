...
class FedAvg:
    ...
    def __init__(
        ...
        seed=None,
        dp_dynamic_noise_multiplier:float=None,
    ):
        """
        Cf class docstring
        """

        print(f"Received dp_dynamic_noise_multiplier: {dp_dynamic_noise_multiplier}, dp_target_epsilon: {dp_target_epsilon}, dp_target_delta: {dp_target_delta}, dp_max_grad_norm: {dp_max_grad_norm}")
        ...
        self.dp_dynamic_noise_multiplier = dp_dynamic_noise_multiplier
        ...
        self.models_list = [
            _Model(
                ...
                logdir=self.logdir,
                seed=self._seed,
                dp_dynamic_noise_multiplier = self.dp_dynamic_noise_multiplier
