...
CHECKPOINT_DIR = "/home/dgxuser16/NTL/mccarthy/ahmad/github/adaptive_privacy_fl/adaptive_privacy/isic/version_02/dyn_noise_1/checkpoints"


class SaveModelStrategy(fl.server.strategy.FedAvg):
    """Overrides FedAvg to save the global model checkpoint after each round."""

    # Override aggregate_fit to save the global model checkpoint
    def aggregate_fit(
        self,
        server_round: int,
